...
template <typename ScalarType>
void assign_complex(thrust::complex<ScalarType>& value, double real, double imag)
{
    value.real(real);
    value.imag(imag);
}
...
template <typename Stream, typename ScalarType>
void write_value(Stream& output, const thrust::complex<ScalarType>& value)
{
...
{
    bool is_complex = thrust::detail::is_same<ValueType, thrust::complex<typename norm_type<ValueType>::type> >::value;
