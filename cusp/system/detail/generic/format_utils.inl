                      ...
                      cusp::csr_format)
{
    ...
    cusp::detail::temporary_array<IndexType, MemorySpace, DerivedPolicy> row_indices(exec, A.num_entries);
                       ...
                       const ArrayType2& column_indices )
{
    ...
    cusp::detail::temporary_array<IndexType, MemorySpace, DerivedPolicy> values(exec, num_rows + num_cols);
