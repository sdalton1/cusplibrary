              ...
              coo_format)
{
    ...
    cusp::sort_by_row(exec, C.row_indices, C.column_indices, C.values, 0, int(C.num_rows));
}
              ...
              coo_format)
{
    ...
    cusp::sort_by_row_and_column(exec, C.row_indices, C.column_indices, C.values, 0,int( C.num_rows), 0, int(C.num_cols));
}
